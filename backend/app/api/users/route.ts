...
export async function GET(req: NextRequest) {
  try {
    ...
    const users = await User.find(query).select('_id firstName lastName email role clientType profileImage isEmailVerified isAdminVerified emailVerificationToken city postalCode createdAt rating linkedin');
